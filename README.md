...
- **The Line and Clustered Column Chart**: Repeat purchasers are more satisfied than one-time buyers.

There’s a visible drop in satisfaction for customers who did not return after their first purchase.

This suggests that customer satisfaction is linked to customer loyalty—happy customers are more likely to return.
